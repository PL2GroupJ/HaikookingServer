...
if __name__ == '__main__':
    ...
    wordcloud = WordCloud(background_color="lightcyan", mode="RGB", font_path="meiryo.ttc",
                          mask=logo_mask, width=600, height=600, colormap="gist_rainbow").generate(textList[0])
    wordcloud.to_file("image/total_wordcloud.png")

    wordcloud = WordCloud(background_color="lightcyan", mode="RGB", font_path="meiryo.ttc",
                          mask=weekly_mask, width=600, height=600, colormap="gist_rainbow").generate(textList[1])
